                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Add Class</h4>
                                    <span>Fill below form to add a Class</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">Add Class</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="actions/add_class_p.php" method="POST">
                                        <div class="form-group row">
                                            ...
                                            <label for="" class="col-sm-2 col-form-label">Input Size of the
                                                class</label>
                                            <div class="col-sm-10 m-b-5">
                                                <input type="number" class="form-control"
                                                    placeholder="Size of the class" name="size" required>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <div class="row">
                                                <div class="col-sm-12 text-right">
                                                    <button type="submit" class="btn btn-primary m-r-10">Submit
                                                        Details</button>
