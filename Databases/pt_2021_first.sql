...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2021 at 10:00 AM
...
(203, 'COM 111', 'INTRODUCTION TO COMPUTING', 2, 0, 0, 0),
...
--
ALTER TABLE `breaks`
  MODIFY `break_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `lecture_schedule`
  MODIFY `LSID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;
