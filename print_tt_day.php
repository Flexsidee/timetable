                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xl-12">
                        ...
                        <div id="forTable" class="dt-responsive table-responsive">
                            <table style="border: 2px black solid; border-collapse: collapse; text-align: center; font-weight: bold;font-size: 70%;">
...
//    })
    function show(dayId){
        ...
        print()
        window.location.replace("view_day_timetable.php");
    }
    </script>
