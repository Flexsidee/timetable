                    ...
                    <div class="col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Select Level and department to view thier timetable</h4>
                            </div>
                            <div class="card-block">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 m-b-5">
                                                ...
                                                <?php 
                                                    $sql= mysqli_query($db, "select * from vw_department_full");
                                                    while($class= $sql -> fetch_assoc()){
                                                ?>
                                                <option value="<?php echo $class['class_id']; ?>">
                                                <?php echo $class['level_name']." ".$class['department_name'];?>
                                                </option>
                        ...
                        <div id="forTable" class="dt-responsive table-responsive">
                            <table id="basic-btnn" class="table table-striped table-hover table-bordered nowrap" style="font-size: 80%;text-align:center;">
                                <thead>
                                    <th>Days</th>
                                    <th>Levels</th>
                                    <th>Department</th>
...
<script>
    ...
    $('#viewTimetable').click(function(){
        ...
        $('#printLink').attr('href', 'print_tt_dept.php?classId=' + $("#class").val());
